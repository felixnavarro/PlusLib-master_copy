...
public:
  //----------------------------------------------------------------------------
  vtkPlusThorLabsVideoSourceInternal()
...
//----------------------------------------------------------------------------
vtkPlusThorLabsVideoSource::vtkPlusThorLabsVideoSource()
: Internal(new vtkPlusThorLabsVideoSourceInternal)
, InstrumentName(NULL)
...
//----------------------------------------------------------------------------
PlusStatus vtkPlusThorLabsVideoSource::InternalConnect()
{
  ...
  {
    LOG_ERROR("Unable to access video source in vtkPlusThorLabsVideoSource. Critical failure.");
    tlccs_close(this->Internal->InstrumentHandle);
    return PLUS_FAIL;
  }
...
PlusStatus vtkPlusThorLabsVideoSource::InternalDisconnect()
{
  // close camera
  tlccs_close(this->Internal->InstrumentHandle);
  return PLUS_SUCCESS;
...
//----------------------------------------------------------------------------
PlusStatus vtkPlusThorLabsVideoSource::InternalUpdate()
{
...
//----------------------------------------------------------------------------
PlusStatus vtkPlusThorLabsVideoSource::InternalStopRecording()
{
  return PLUS_SUCCESS; 
}

//----------------------------------------------------------------------------
PlusStatus vtkPlusThorLabsVideoSource::NotifyConfigured()
{
