...
{
  vtkPlusIntersonSDKCxxVideoSource *  ActiveIntersonDevice;
};
...
//----------------------------------------------------------------------------
void vtkPlusIntersonSDKCxxVideoSource::NewBmodeImageCallback( BmodePixelType * buffer, void * clientData )
{
  if( buffer == NULL )
    {
  ...
  vtkPlusIntersonSDKCxxVideoSource * activeIntersonDevice = callbackClientData->ActiveIntersonDevice;
  ...
  if( activeIntersonDevice != NULL )
    ...
    {
    LOG_ERROR("vtkPlusIntersonSDKCxxVideoSource B-mode callback but the ActiveIntersonDevice is NULL.  Disconnect between the device and SDK.");
    return;
    }
}

//----------------------------------------------------------------------------
void vtkPlusIntersonSDKCxxVideoSource::NewRfImageCallback( RfPixelType * buffer, void * clientData )
{
  if( buffer == NULL )
    {
    LOG_ERROR("No actual frame data received");
...
class vtkPlusIntersonSDKCxxVideoSource::vtkInternal
{
public:
  vtkPlusIntersonSDKCxxVideoSource *External;

  //----------------------------------------------------------------------------
  vtkPlusIntersonSDKCxxVideoSource::vtkInternal::vtkInternal(vtkPlusIntersonSDKCxxVideoSource* external) 
    : External(external)
  {	
  ...
  //----------------------------------------------------------------------------
  vtkPlusIntersonSDKCxxVideoSource::vtkInternal::~vtkInternal() 
  {    
    this->External = NULL;
    delete HWControls;
    delete Scan2DClass;
  ...
  {
    this->Scan2DClass->SetNewBmodeImageCallback( &vtkPlusIntersonSDKCxxVideoSource::NewBmodeImageCallback,
  ...
  {
    this->Scan2DClass->SetNewRFImageCallback( &vtkPlusIntersonSDKCxxVideoSource::NewRfImageCallback,
      &(this->RfClientData) );
  }
...
//----------------------------------------------------------------------------
vtkPlusIntersonSDKCxxVideoSource::vtkPlusIntersonSDKCxxVideoSource():
  PulseVoltage( 30 ),
  RfDecimation( 0 )
{
...
//----------------------------------------------------------------------------
void vtkPlusIntersonSDKCxxVideoSource::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
PlusStatus vtkPlusIntersonSDKCxxVideoSource::InternalConnect()
{
  LOG_TRACE( "vtkPlusIntersonSDKCxxVideoSource::InternalConnect" );
...
//----------------------------------------------------------------------------
PlusStatus vtkPlusIntersonSDKCxxVideoSource::InternalDisconnect()
{
...
//----------------------------------------------------------------------------
PlusStatus vtkPlusIntersonSDKCxxVideoSource::InternalStartRecording()
{
  Scan2DClassType * scan2D = this->Internal->GetScan2DClass();
  scan2D->AbortScan();
...
//----------------------------------------------------------------------------
PlusStatus vtkPlusIntersonSDKCxxVideoSource::InternalStopRecording()
{ 
  HWControlsType * hwControls = this->Internal->GetHWControls();
...
//----------------------------------------------------------------------------
PlusStatus vtkPlusIntersonSDKCxxVideoSource::InternalUpdate()
{
...
//-----------------------------------------------------------------------------
PlusStatus vtkPlusIntersonSDKCxxVideoSource::ReadConfiguration(vtkXMLDataElement* config)
{
  LOG_TRACE("vtkPlusIntersonSDKCxxVideoSource::ReadConfiguration"); 
  if ( config == NULL )
  {
...
//-----------------------------------------------------------------------------
PlusStatus vtkPlusIntersonSDKCxxVideoSource::WriteConfiguration(vtkXMLDataElement* rootConfigElement)
{
...
//----------------------------------------------------------------------------
PlusStatus vtkPlusIntersonSDKCxxVideoSource::NotifyConfigured()
{
  if( this->OutputChannels.size() > 2 )
  {
    LOG_WARNING("vtkPlusIntersonSDKCxxVideoSource is expecting at most two output channels and there are " << this->OutputChannels.size() << " channels.");
  }

  if( this->OutputChannels.empty() )
  {
    LOG_ERROR("No output channels defined for vtkPlusIntersonSDKCxxVideoSource. Cannot proceed." );
...
//----------------------------------------------------------------------------
std::string vtkPlusIntersonSDKCxxVideoSource::GetSdkVersion()
{
  return this->Internal->GetSdkVersion();
}

//----------------------------------------------------------------------------
PlusStatus vtkPlusIntersonSDKCxxVideoSource::SetPulseVoltage(unsigned char voltage)
{
...
//----------------------------------------------------------------------------
PlusStatus vtkPlusIntersonSDKCxxVideoSource::SetRfDecimation(int enableDecimation)
{
...
//----------------------------------------------------------------------------
PlusStatus vtkPlusIntersonSDKCxxVideoSource::SetProbeFrequencyMhz(double freq)
{
...
//----------------------------------------------------------------------------
PlusStatus vtkPlusIntersonSDKCxxVideoSource::SetDynRangeDb(double dynRangeDb)
{
...
//----------------------------------------------------------------------------
PlusStatus vtkPlusIntersonSDKCxxVideoSource::AddBmodeFrameToBuffer( BmodePixelType * buffer, void * clientData )
{
  if( !this->Recording )
    {
...
//----------------------------------------------------------------------------
PlusStatus vtkPlusIntersonSDKCxxVideoSource::AddRfFrameToBuffer( RfPixelType * buffer, void * clientData )
{
  if( !this->Recording )
    {
    // drop the frame, we are not recording data now
