...
//----------------------------------------------------------------------------
PlusCivcoBrachyStepper::PlusCivcoBrachyStepper(unsigned long COMPort/*=1*/, unsigned long BaudRate/*=9600*/)
{
  this->m_COMPort = 0;
...
//----------------------------------------------------------------------------
PlusStatus PlusCivcoBrachyStepper::GetDeviceModelInfo(std::string& version, std::string& model, std::string& serial)
{
  long lModel = 0;
  long lSerialNumber = 0;
  long lVersion = 0;
...
//----------------------------------------------------------------------------
PlusStatus PlusCivcoBrachyStepper::GetSeiDeviceInfo(long devnum, long& model, long& serialnum, long& version, long& addr)
{
