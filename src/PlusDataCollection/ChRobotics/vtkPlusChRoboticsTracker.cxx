...
//-------------------------------------------------------------------------
void vtkPlusChRoboticsTracker::UpdateDataItemValues(ChrSerialPacket& packet)
{
...
//----------------------------------------------------------------------------
PlusStatus vtkPlusChRoboticsTracker::ReadConfiguration(vtkXMLDataElement* rootConfigElement)
{
