...
#ifndef __vtkPlusCenterOfRotationCalibAlgo_h
#define __vtkPlusCenterOfRotationCalibAlgo_h
...
/*!
  \class vtkPlusCenterOfRotationCalibAlgo
...
class vtkPlusCalibrationExport vtkPlusCenterOfRotationCalibAlgo : public vtkObject
{
public:

  static vtkPlusCenterOfRotationCalibAlgo* New();
  vtkTypeMacro(vtkPlusCenterOfRotationCalibAlgo , vtkObject);
